            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'title_gold', title:"获得金币数量"},
                        {field: 'tile_type', title:"类型"},
                        {field: 'key_code', title:"keyCode"},
                        {field: 'content', title:"描述"},
                        {field: 'is_activation', title:"是否有效"},
                        {field: 'effective', title:"活动有效期"},
                        {field: 'button_type', title:"调用方式"},
                      ...
                      //  {field: 'f_number', title:"集数"},
                        {field: 'operate', title: __('Operate'), table: table,  buttons: [
                                {name: 'detail', text: '分享设置', title: '分享设置', icon: 'fa fa-list', classname: 'btn btn-xs btn-primary btn-dialog', url: 'task.play/index'}
