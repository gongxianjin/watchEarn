define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'materail/system/index',
                    add_url: 'materail/system/add',
                    edit_url: 'materail/system/edit',
                    del_url: 'materail/system/del',
                    table: 'materail',
                }
            });
            var table = $("#table");
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'c_id', title:"分类id"},
                        {field: 'meterial_url', title:"素材地址"},
